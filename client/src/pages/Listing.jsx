    ...
    <main>
        ...
        {listing && !loading && !error && (
            ...
            <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                ...
                {listing.name} - ${' '}
                {listing.offer
                    ? listing.discountPrice.toLocaleString('ua-UA')
                    : listing.regularPrice.toLocaleString('ua-UA')}
                ...
                {/* 
                {currentUser && listing.userRef !== currentUser._id && !contact && (console.log(listing.userRef, currentUser._id)
                <button
